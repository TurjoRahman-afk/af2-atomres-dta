"""Training script for AF2-PocketCross-DTA — attention-pooling variant (model_pocketcross_attnpool.py).
...
from model_pocketcross_attnpool import MODEL as Model
...
if __name__ == "__main__":
    ...
    print(f"Dataset-{hp.dataset}-{hp.running_set}  (AF2-PocketCross-DTA, attention-pooling variant)")
